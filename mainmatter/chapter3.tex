...
To `ease the player into' the technique, \violaPiece begins with a \emph{sul ponticello} open C string, which drones for a few seconds before crescendoing while moving the bow towards the fingerboard and slowing the bowing speed down.

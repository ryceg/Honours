...
Gould states ``wherever possible, retain the same clef for both fingered and sounding pitches''.\autocite[422]{gouldBars2011}
This is sometimes practical, but gives rise to the issue of indicating pitch. 
She once again suggests several practical methods of communicating resultant pitch, as a ``small [black] notehead [without a stem] in brackets directly above or after the fingered pitches'', an ossia stave with the resultant pitches above, or notated in a footnote using a cue stave.\autocite[421]{gouldBars2011}
This advice is for harmonics, but can be applied to multiphonics as evidenced in \autoref{fig:multiphonicNotationOneLine}

...
%   \caption{Notation of subharmonics from Long's website, \emph{The Modern Double Bass}.}
% \label{fig:Notation of subharmonics from Long's website, \emph{The Modern Double Bass}}
% \end{figure}
